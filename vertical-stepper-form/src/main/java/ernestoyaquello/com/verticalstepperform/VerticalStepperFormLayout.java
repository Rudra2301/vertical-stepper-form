...
public class VerticalStepperFormLayout extends RelativeLayout implements View.OnClickListener {
    ...
    protected List<Button> stepsButtonViews;
    ...
    protected List<String> stepsButtonTexts;
    ...
    /**
     * Returns the button text of step
     *
     * @param stepNumber The step number (counting from 0)
     * @return the text button string
     */
    public String getStepsButtonText(int stepNumber) {
        return stepsButtonTexts.get(stepNumber);
    }
    ...
    /**
     * Set the text of button step
     *
     * @param stepNumber The step number (counting from 0)
     * @param title      New title of the step button
     */
    public void setStepButtonText(int stepNumber, String title) {
        if (title != null && !title.equals("")) {
            stepsButtonTexts.set(stepNumber, title);
            Button button = stepsButtonViews.get(stepNumber);
            if (button != null) {
...
//        nextButton.setAlpha(alphaOfDisabledElements);
     ...
     * @deprecated use {@link Builder#newInstance(VerticalStepperFormLayout, String[], String[], VerticalStepperForm, Activity)} instead like this:
     * <blockquote><pre>
     ...
     */
    @Deprecated
    public void initialiseVerticalStepperForm(String[] stepsTitles, String[] stepsButtonTexts,
        ...
        initStepperForm(stepsTitles, null, stepsButtonTexts);
    }
    ...
    protected void initialiseVerticalStepperForm(Builder builder) {
        ...
        initStepperForm(builder.steps, builder.stepsSubtitles, builder.stepsButtonTexts);
    }

    protected void initStepperForm(String[] stepsTitles, String[] stepsSubtitle, String[] stepsButtonTexts) {
        setSteps(stepsTitles, stepsSubtitle, stepsButtonTexts);
    ...
    protected void setSteps(String[] steps, String[] stepsSubtitles, String[] stepsButtonTexts) {
        this.steps = new ArrayList<>(Arrays.asList(steps));
        this.stepsButtonTexts = new ArrayList<>(Arrays.asList(stepsButtonTexts));
    ...
    protected void initializeForm() {
        ...
        stepsButtonViews = new ArrayList<>();
    ...
    protected LinearLayout createStepLayout(final int stepNumber) {
        ...
        AppCompatButton nextButton = (AppCompatButton) stepLayout.findViewById(R.id.next_step);
        nextButton.setText(stepsButtonTexts.get(stepNumber));
        stepsButtonViews.add(stepNumber, nextButton);
    ...
    public static class Builder {
        ...
        protected String[] stepsButtonTexts;
        protected VerticalStepperForm verticalStepperFormImplementation;
        protected Activity activity;
         ...
         * @param stepsButtonTexts      a String array with the texts buttons of the steps
        ...
        public static Builder newInstance(VerticalStepperFormLayout stepperLayout,
            ...
            return new Builder(stepperLayout, stepTitles, stepsButtonTexts, stepperImplementation, activity);
        }
